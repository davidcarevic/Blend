...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 18, 2018 at 10:19 AM
...
(8, 'index.php?page=logout', 'Log Out', 2),
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin@admin.com', 'David', 'Carevic', 1),
(27, 'David', '153d80ef61dfbec00f88bea64a20c9f0', 'david@david.com', 'David', 'David', 2),
...
--
ALTER TABLE `user_poll`
  ADD CONSTRAINT `user_poll_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `user_poll_ibfk_2` FOREIGN KEY (`id_vote`) REFERENCES `poll` (`id`);
COMMIT;
